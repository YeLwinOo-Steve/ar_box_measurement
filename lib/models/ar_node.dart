...
class ARNode {
  ...
  set scale(Vector3 value) {
    // transform.setFromTranslationRotationScale(position, Quaternion.fromRotation(rotation), value);
    // final old = Matrix4.fromFloat64List(transform.storage);
    // final newT = old.clone();
    // newT.matrixScale = value;
    // transform = newT;
...
extension Matrix4Extenstion on Matrix4 {
  set matrixScale(Vector3 scale){
    final translation = Vector3.zero();
    decompose(translation, Quaternion(0, 0, 0, 0), scale);
    setFromTranslationRotationScale(translation, Quaternion(0, 0, 0, 0), scale);
  }
